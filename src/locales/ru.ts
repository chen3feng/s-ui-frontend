export default {
  ...
  upgrade: {
    ...
    doUpgrade: "Обновить до",
    upToDate: "Установлена последняя версия",
    current: "Текущая",
    latest: "Последняя",
    releaseNotes: "Примечания к выпуску",
    confirmTitle: "Подтвердить обновление",
    confirmMsg: "Будет загружена и установлена последняя версия, затем панель перезапустится. Вы уверены?",
    success: "Обновление выполнено! Панель перезапускается...",
  },
}
