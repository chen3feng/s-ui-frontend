export default {
  ...
  upgrade: {
    ...
    doUpgrade: "ارتقا به",
    upToDate: "آخرین نسخه نصب شده است",
    current: "فعلی",
    latest: "آخرین",
    releaseNotes: "یادداشت‌های انتشار",
    confirmTitle: "تأیید ارتقا",
    confirmMsg: "آخرین نسخه دانلود و نصب خواهد شد، سپس پنل مجدداً راه‌اندازی می‌شود. آیا مطمئن هستید؟",
    success: "ارتقا موفقیت‌آمیز بود! پنل در حال راه‌اندازی مجدد است...",
  },
}
